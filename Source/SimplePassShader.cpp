...
namespace luna
{
	SimplePassShader::SimplePassShader()
	{
	}
	...
	void SimplePassShader::Bind(const VkCommandBuffer & commandbuffer)
	{
	...
	void SimplePassShader::SetDescriptors(const VulkanImageBufferObject * finalimage)
	{
	...
	void SimplePassShader::Init(const VkRenderPass & renderpass)
	{
	...
	void SimplePassShader::SetUpFixedPipeline_(FixedPipelineCreationTool & fixedpipeline)
	{
		// no depth test
	...
	void SimplePassShader::CreatePipelineLayout_()
	{
